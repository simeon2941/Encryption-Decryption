/*
  symmetric encryption in block mode  (Algorithm aes, Block mode : EVP_aes_128_cbc())
*/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
void file_encrypt(cipher_params_t* params, FILE* ifp, FILE* ofp)
{
    ...
    cout << "Average time used for encryption: " << dec << (all / count)/1000.0 << " microseconds\n";
    fwrite(out_buf, sizeof(unsigned char), out_len, ofp);
...
int main(int argc, char* argv[])
{
    ...
    params->cipher_type = EVP_aes_128_cfb();
